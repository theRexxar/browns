...
<head>
	...
	<?php echo theme_view('partials/_script'); ?>
									...
									<li>
										<div class="inner">
											<div class="toolbar-profile-img">
                                                ...
                                                <img src="<?php echo site_url('system/themes/admin/images/icon-user.png'); ?>" width="96" title="<?php echo $current_user->display_name; ?>" />
											</div>
