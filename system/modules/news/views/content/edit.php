...
<div class="admin-box">
    ...
    <fieldset>
    	...
    	<div class="control-group <?php echo form_error('image_id') ? 'error' : '' ?>">
    		...
    		<div class="controls">
    			...
    			<a href="#" id="delete-button" class="btn btn-danger delete-image" rel="<?php echo $news['id']; ?>">Remove Image</a>		
        ...
        <input id="author_id" type="hidden" name="author_id" maxlength="11" value="<?php echo set_value('author_id', isset($news['author_id']) ? $news['author_id'] : ''); ?>"  />



        <div class="form-actions">
            <br/>
            <input type="submit" name="submit" class="btn btn-primary" value="Edit News" />
    ...
    <?php if ($this->auth->has_permission('News.Content.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/news/delete/'. $id);?>" onclick="return confirm('<?php echo lang('news_delete_confirm'); ?>')" name="delete-me">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('news_delete_record'); ?>
            </a>
...
<script>
    var URL_IMAGE   = '<?php echo site_url(SITE_AREA ."/content/news/delete_image") ?>' ;
    var URL_GALLERY = '<?php echo site_url(SITE_AREA ."/content/news/delete_gallery") ?>' ;
</script>