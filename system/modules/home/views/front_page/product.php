		...
		<div class="container b-b ">
			<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
				<article class="text-center">
					<h3 class="title-header">Grace</h3>
					<h3 class="sub-title-header title-label">In Every Detail <i class="icon-symbol"></i></h3>
					<b>Quality, Style, Exclusivity</b>
					<p>We shall deliver you the results of our works neatly in every detail as neatness is our primary standard. So that the elegance and beauty of the product may be revealed  for your satisfaction only. </p>
				</article>
			</div>
		</div>
	</section>
	<section id="home-product">
		<div class="container">
			<div class="row no-gutter">
				...
				<div class="col-lg-6 col-sm-6 col-md-6">
					<figure>
						<img src="<?php echo base_url();?>public/img/product/img_thumb_room.jpg" alt="Private Residences">
					</figure>
				</div>
			</div>
			<div class="row no-gutter">
			...
			<div class="row no-gutter">
				...
				<div class="col-lg-6 col-sm-6 col-md-6">
					<figure>
						<img src="<?php echo base_url();?>public/img/product/img_thumb_other.jpg" alt="Other Creations">
					</figure>
				</div>
			</div>
		</div>
