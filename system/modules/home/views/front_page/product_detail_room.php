<div class="wrapper-container inside">
	<section id="intro">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/img_room_01.jpg" alt="product room one">
			</figure>
		</div>
	</section>
	<section id="product-detail">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/img_room_02.jpg" alt="product room two">
				<img src="<?php echo base_url();?>public/img/product/img_room_03.jpg" alt="product room three">
				<img src="<?php echo base_url();?>public/img/product/img_room_04.jpg" alt="product room four">
			</figure>
		</div>
	</section>
		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-lg-6 col-sm-6 col-md-6">
					<figure>
						<img src="<?php echo base_url();?>public/img/product/img_thumb_dining.jpg" alt="Product dining">
					</figure>
				</div>
				<div class="col-lg-6 col-sm-6 col-md-6">
