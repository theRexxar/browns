<div class="wrapper-container inside">
	<section id="intro">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/other/others01.jpg" alt="product Other">
			</figure>
		</div>
	</section>
	<section id="product-detail">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/other/others02.jpg" alt="product other two">
				<img src="<?php echo base_url();?>public/img/product/other/others03.jpg" alt="product other three">
				<img src="<?php echo base_url();?>public/img/product/other/others04.jpg" alt="product other four">
				<img src="<?php echo base_url();?>public/img/product/other/others05.jpg" alt="product other five">
			</figure>
		</div>
	</section>
		...
		<div class="container">
			<div class="row no-gutter">
				<div class="col-lg-6 col-sm-6 col-md-6">
					<figure>
						<img src="<?php echo base_url();?>public/img/product/img_thumb_room.jpg" alt="Private venues">
					</figure>
				</div>
				<div class="col-lg-6 col-sm-6 col-md-6">
			...
			<div class="row no-gutter">
				...
				<div class="col-lg-6 col-sm-6 col-md-6">
					<figure>
						<img src="<?php echo base_url();?>public/img/product/img_thumb_dining.jpg" alt="Business venues">
					</figure>
				</div>
			</div>
		</div>
