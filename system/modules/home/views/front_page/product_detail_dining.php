<div class="wrapper-container inside">
	<section id="intro">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/img_dining_01.jpg" alt="product indoor one">
			</figure>
		</div>
	</section>
	<section id="product-detail">
		...
		<div class="text-center product-banner">
			<figure>
				<img src="<?php echo base_url();?>public/img/product/img_dining_02.jpg" alt="product dining two">
				<img src="<?php echo base_url();?>public/img/product/img_dining_03.jpg" alt="product dining three">
			</figure>
		</div>
	</section>
